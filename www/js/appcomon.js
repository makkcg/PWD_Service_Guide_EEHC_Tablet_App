...
var signdic_services_server_path="http://169.50.5.146/deaf_service_apps/services/";
var apptype="androidTab";/****Android_online ,IOS_online, desktop, androidTab*/
var timetostartapp=300;
...
var serverdomainNpath="http://eehcaccessibility.com/tablet/";
...
var onlinedatapath=serverdomainNpath+"backend/data/";
var originSource=""
...
function checkNetConnection(){
 ...
 var file = serverdomainNpath+"mobileapp/imgs/ajax-loader.gif";
...
$(document).ready(function () {
	...
	$(document).on('mouseup', '.enterbtn , .servucebox a.subserviceslink',function(event){
