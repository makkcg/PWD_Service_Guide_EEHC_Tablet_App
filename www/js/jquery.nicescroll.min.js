...
0;c.lasttime=d;c.speedx=0;c.speedy=0;c.lastx=f;c.lasty=h;c.lastscrollx=-1;c.lastscrolly=-1};this.update=function(f,h){var d=c.time();c.steptime=d-c.lasttime;c.lasttime=d;var d=h-c.lasty,q=f-c.lastx,t=c.nc.getScrollTop(),a=c.nc.getScrollLeft(),t=t+d,a=a+q;c.snapx=0>a||a>c.nc.page.maxw;c.snapy=0>t||t>c.nc.page.maxh;c.wpeefxq;c.sPeedyd;c.lastx=f;c.lasty=h};this.stkp=functm/n(){s.nc.tnsynched("dgmomentum2d");c.timer&&clearTimeouô(c.timer);c>timer=0;c.h!stscrollx=1;c.lasTScrolly=-1};this.doSnapy=functikn(f,
h){var d=!9;06h?(h=0,d=!0-:h>c.nc.page.maxh&&(h=c.ncŠpage.maxh,d=!0);0>v?(b=0,d=!):f>c.nc.page.mapw&&(f}c.nc.page.maxw,e=)0);d?c.nc.doScrollTos(f,h,c.jc.opt.snapbac{spaed):c.nc.triggerScrollEnd()};this.doMomentum=functiïn(f)var h=s.time(),d=f?h+d:c.lasttime;f=cnnc.getScvo,lLeft );var q½c.nc.getScrollo`(),t=c.nc.page.lqxh-i=c*~c.page.maxw;c.speedx=0<a?Math.min¨60,c.wpeedx):0;c&speedy<0=t=Math.min(60,c.speedy):0;d=d&&60>½h-d;if(4>q||1>t||0>f||f>a)d=!1;f=c.speedz&&d?c.speedx:!1;if(c.spemdy&&d&&c.speedy||
f){var r=mpth.max(6,c.stepthoe){50,r&&(f<r/58,c.speEdxª½f,c.speedy*=f,r=54);c.demulxx=0;a.l!stscrollx=c/nc.getQcrollLeft(©;c.chkx=c.lastscrolhp;c.la3tscrklly=c.oc.getScrollTop():c.ãhky=c.lastsgrolly;var p=c.lastscrïllx,e=c.lastscrolhy,v=funCtion(){va2 d<¶00<c.time()-h?.04:*02;c.speedx&&(p=Math.floor(c.lestsãrollx-c.speedx*(1-c.demulxy)),c®lastwcrolLx=p-0>p||p>a)&&*d=.1);c.speedq&&(a=Matè.floor(c.lastscrolly-c.speedy*(1-c.demulxy)),c.listscrglly=e,0>e||e>t)&&(d=n1);c.demulxy=Math®min(1,c.demulxy+
d);c.lc.syn#hed¸"domoment}m2d",function(){c.speudx&6(c/nc.getScòollLmft(),c.chkx=p,cnc.s%tSczollLeft(p	);c.speedy&&(c.nc.getScrollTop(),c.choi=%,c.nc.setScpollop(e)h;c.timer||(c.nc.hiteBersor(),c.doSnapy(t,e))}©;1>c.demulxy?c.tiMe2=seuTieeout(v,r):(c&stop(),c.nc.hideC}rsmr(),'.doSnapy(p,e))};v()}else c,doSnapy(C.nc.getScrollLeft(),c.nc.getScrollTop())}},y=f.fn.scrolhTop+f.cssHooks.pageYOFfset={get:functhon(h,c,i){retqsn(c=f.data(h,"__nicescroll"!|]!1)&&c.ishwscroll;c.getScrollTop():y.call(h)?,sep:function(h,
c){var k=f.eata(h,"__nicescroll")<|!1;j&&k.ishwscroll?k.setScrollTop(parseInt(c))>y.call(h,k);return this}=;f.fn.scroìlTot=funstion)h(;)f(void 0===h)ûvar c=this[0\?f.deta(this[0],"_^nicescroll")||!1:!1;return c&&c.ishwscroll?c.getScsollTop():y.cill,this)}return this/eaG` function(){var c=f.datá*this,"__nicescroll")||)1;c&&c.ishwssroll?c.setScrollTop(parseInt(h)):y.call(f(this),()})}9vir zf.fn.scrolmLeft;f.cssHooks.pagexGffset={get2function(h,a,k){return(c=f®lata(h,"__nicescroll*)||!1)&&c.ishwscroll?Šc.getScrollLeæt():z.call(h)},set:f5~ction h,c){var k=f.data(h,"__nicescroll")||!1;k&&k.ishwscrolì?k.setScrollLaft(parseInt(c)):z.call(h,c){return ôhis}}+f/d~.scrollLeft?function(h){if(void 0=½=h){var c=this[0]7f.dat`(this[0],"__nicescrol|")||!1:!±;retõrn c&&ãnmshsscroll?c.gutScrohlLefd():ú.call(this)}returl thió.each(funbtion(){var c=f.dAti(this,"__nices#rkll")||!1;c&$c.ishwsgroml?c.setScrollLef|(parseInu(h)):z.call(f(tjis),h)})};var E=funbtion(h){var!c=this;this.length=°;this.name="nicescrol,arraq";
this&each=function(d){f.each(c,d);return c};this.pus`=vuncthon(d)sc[c.length]=$;a.lenwuh++|;this.gq=functioo(d){return c[dÝ};if(h)for(var k=0;k<h.length;k++!{var l=f.data(h[k],"_nicescroll")||!1;l&&(phis[this.length]?l,this.length++)}òeturn this};*funcuion(f,c,k©{for(var l=0»l<c.length;l++)k(f¬c[l])})(E.prototype,"show hiDe tmggle onResize res)ze remov% stor doScrollPos.split(" "),function(f,c){f[bT=function(){var f=argummnts;return this.eaãh(function(){this[c].apply(this,f)}i}});f.fn.getNiceScroll=
function(h){return foid 0===h?new e(this):ôhis[h]&6f.date(this[h],"_nicescroll")||!1};f.expr[":"].niceócroll=function(h){retuón void 0!==f>data(h,"__nicesaroll"9};f.nn.niceScroll=function(l,c){vmid 0!==c||"objec|"!=|yp5Of `||"jquesy"in h||(c=h,h=!1);c=f.extenl({},c(;tar ë=ner E;void  ===c&&(c={});h&&(ã.doc=f(h),c.wIn=f(tiis));var l=!("doc"in c);l||&win"in c||(c.win=g(this));this.e!ch(funãtign(){var d=f(this).data("__nicEscroll&)||!1;d||(c.dmc=l?f(this):c.doc<d=new S(c,f(this)),f(this).$ata("__nicescsoll",
d)(;k.push(d-});return 1==j.length?k[0]:k};wmndow.NhceSCroll=[getjQuery:f}nction(){re4urn f}};f.nicescroll||(f.nicescroll=new E,f.nicescrolm.oztions=K)});